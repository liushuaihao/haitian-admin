		...
		<div class="mod-sys__user">
          ...
          <ren-dept-tree v-model="dataForm.deptId" :placeholder="$t('dept.title')" :query="true"></ren-dept-tree>
			...
			<el-table v-loading="dataListLoading" :data="dataList" border @selection-change="dataListSelectionChangeHandle" @sort-change="dataListSortChangeHandle" style="width: 100%;">
				...
				<el-table-column prop="mobile" :label="$t('user.mobile')" min-width="110px" header-align="center" align="center"></el-table-column>
				<el-table-column prop="idCard" label="身份证号" min-width="200px" header-align="center" align="center"></el-table-column>
        </el-table-column>
				<el-table-column prop="userType" label="角色" align="center" width="80"></el-table-column>
				<el-table-column prop="cityName" label="所属区域" header-align="center" min-width="140px" align="center"></el-table-column>
