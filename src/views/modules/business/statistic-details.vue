<template>
  <el-card>
    ...
    <el-card v-if="dataForm.System=='xindian'||dataForm.System=='all'" class="tjx">
      <h4>心电情况统计</h4>
    </el-card>

    <el-card v-if="dataForm.System=='huxi'||dataForm.System=='all'" class="tjx">
      <h4>呼吸情况统计</h4>
    </el-card>

    <el-card v-if="dataForm.System=='bubinbufu'||dataForm.System=='all'" class="tjx">
      <h4>步频步幅度情况统计</h4>
    </el-card>

    <el-card v-if="dataForm.System=='yundong'||dataForm.System=='all'" class="tjx">
      <h4>运动及步态情况统计</h4>
    </el-card>

    <el-card v-if="dataForm.System=='yundongliang'||dataForm.System=='all'" class="tjx">
      <h4>运动量情况统计</h4>
    </el-card>
  </el-card>
</template>
